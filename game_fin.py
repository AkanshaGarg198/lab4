...
def remove_punct(text):
    ...
    userinput= text.translate(translation)
...
def normalise_input(user_input):
    ...
    normalise=user_input
    normalise=remove_punct(normalise)
...
def display_room(room):
    ...
    is printed in all capitals and framed by blank lines. Then follows thes
